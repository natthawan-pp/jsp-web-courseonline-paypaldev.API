<%-- 
    Document   : login_fail
    Created on : Sep 26, 2019, 8:27:53 PM
    Author     : lenovo
--%>
...
<html lang="en">
    ...
    <body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
        ...
        <div class="alert alert-danger" role="alert" style="height: 50px; font-size: 16px">
            <center> The email or password you entered is invalid. <a href="index.html" class="alert-link">Try again</a>. </center>
        </div>
